...
public class FeedFragment extends ListFragment implements SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = String.format("%s.%s", Constants.APPBOY_LOG_TAG_PREFIX, com.appboy.ui.AppboyFeedFragment.class.getName());
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup container, Bundle savedInstanceState) {
        View view = layoutInflater.inflate(R.layout.fragment_feed, container, false);
        mNetworkErrorLayout = (LinearLayout) view.findViewById(R.id.feed_network_error);
        mLoadingSpinner = (ProgressBar) view.findViewById(R.id.feed_loading_spinner);
        mEmptyFeedLayout = (LinearLayout) view.findViewById(R.id.feed_empty_feed);
        mFeedRootLayout = (RelativeLayout) view.findViewById(R.id.feed_root);
        ...
        mFeedSwipeLayout.setColorScheme(R.color.blue_bright,
                R.color.green_light,
                R.color.orange_light,
                R.color.red_light);
        mTransparentFullBoundsContainerView = view.findViewById(R.id.feed_transparent_full_bounds_container_view);
        return view;
    }
