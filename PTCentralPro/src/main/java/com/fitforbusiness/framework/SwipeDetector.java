...
import com.fitforbusiness.nafc.assessment.AssessmentFormActivity;

/**
 * Created by Sanjeet on 09-Jun-14.
 */
public class SwipeDetector implements View.OnTouchListener {

    public SwipeDetector(FragmentActivity accreditationFragment) {

    }
    public SwipeDetector(AssessmentFormActivity assessmentFormActivity) {
