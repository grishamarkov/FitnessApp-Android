 ...
 * 
 */
public class DwollaDialog extends Dialog {
	...
	public DwollaDialog(Context context, String url, String callbackUrl, OAuthDialogListener listener) {
		super(context);
		mUrl = url;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		DwollaUtils.removeAllCookies(getContext());
	}
	...
	private class OAuthWebViewClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			com.fitforbusiness.oauth.stripe.AppLog.d(TAG, "OAuthWebViewClient.shouldOverrideUrlLoading", "Redirecting URL " + url);

			if (url.startsWith(mCallbackUrl)) {

				String queryString = url.replace(mCallbackUrl + "/?", "");
				com.fitforbusiness.oauth.stripe.AppLog.d(TAG, "OAuthWebViewClient.shouldOverrideUrlLoading", "queryString:" + queryString);
		...
		public void onReceivedError(WebView view, int errorCode,
			...
			com.fitforbusiness.oauth.stripe.AppLog.e(TAG, "OAuthWebViewClient.onReceivedError", "Page error[errorCode=" + errorCode + "]: " + description);
		...
		public void onPageStarted(WebView view, String url, Bitmap favicon) {
			...
			com.fitforbusiness.oauth.stripe.AppLog.d(TAG, "OAuthWebViewClient.onPageStarted", "url: " + url);
			mSpinner.show();
		}
