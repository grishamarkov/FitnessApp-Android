...
public class StripeButton extends Button {
    ...
    private void setupButton() {
        ...
        setClickable(true);
        setBackgroundResource(R.drawable.custom_btn_blue);
            ...
            public void onClick(View v) {
                ...
                if (mStripeApp.isConnected()) {
                    ...
                    if (mConnectMode == StripeApp.CONNECT_MODE.DIALOG) {
                        ...
                        Log.d("stripe", "callback " + mStripeApp.getCallbackUrl());
                        Log.d("stripe", "auth " + mStripeApp.getAuthUrl());
                        Log.d("stripe", "token " + mStripeApp.getTokenUrl());
